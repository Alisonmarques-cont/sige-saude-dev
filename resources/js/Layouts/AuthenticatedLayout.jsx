...
{/* Contratos */}
                    <div>
                        ...
                        {openMenus.contratos && (
                            <div className="bg-[#2c3b41] py-1">
                               {/* LINK DIRETO PARA O HUB DE CONTRATOS */}
                    <Link
                        href={route('contratos.processos.index')}
                        className={`flex items-center px-4 py-3 text-sm font-medium transition-colors ${
                            isActive('contratos.*')
                                ? 'bg-[#3c8dbc] text-white border-l-4 border-blue-300'
                                : 'text-[#b8c7ce] hover:bg-[#2c3b41] hover:text-white border-l-4 border-transparent'
                        }`}
                    >
                        <svg className="mr-3 h-5 w-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        Contratos
                    </Link>
                            </div>
                        )}
